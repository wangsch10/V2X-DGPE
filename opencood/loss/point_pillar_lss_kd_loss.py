...
class PointPillarLssKDLoss(PointPillarLoss):
    def __init__(self, args):
        super(PointPillarLssKDLoss, self).__init__(args)
        self.kd = args['kd']
    ...
    def forward(self, output_dict, target_dict):
        ...
        # print('teacher.shape->{}'.format(teacher_feature.shape))
        # print('student.shape->{}'.format(feature.shape))
