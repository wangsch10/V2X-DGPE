...
class LssUniDistillLoss(PointPillarLoss):
    def __init__(self, args):
        super(LssUniDistillLoss, self).__init__(args)
        self.kd = args['kd']
        print('using LssUniDistillLoss: feature: {}, relation: {}, response: {}, intermediate: {}'.format(self.kd['feature_kd'], self.kd['relation_kd'], self.kd['response_kd'], self.kd['intermediate_kd']))
