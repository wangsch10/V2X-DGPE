...
class PointPillarDiscoNetV2xvit(nn.Module):
    def __init__(self, args):
        super(PointPillarDiscoNetV2xvit, self).__init__()
        ...
        print('multi_scale status1:', self.multi_scale)
    ...
    def forward(self, data_dict,history_spatial_features_2d):
        ...
        if self.multi_scale: #false
            ...
            if self.vis_feats: ##false
                ...
                regroup_feature_history=self.stcm(regroup_feature_history, prior_encoding_history,mask, spatial_correction_matrix_history)
