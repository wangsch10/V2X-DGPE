...
class PointPillarDiscoNetV2xdgpeNoise(nn.Module):
    def __init__(self, args):
        super(PointPillarDiscoNetV2xdgpeNoise, self).__init__()
    ...
    def forward(self, data_dict,history_spatial_features_2d):
        ...
        if self.multi_scale: #false
            ...
            if self.vis_feats: ##false
                ...
                x_train[replace_indices] = history_out #[4, 2, 100, 252, 256]
        ...
        output_dict.update({'feature_before_fusion': x_train_compensation,#spatial_features_2d,[8, 256, 100, 252]
