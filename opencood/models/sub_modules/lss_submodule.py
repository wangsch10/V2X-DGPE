...
from opencood.models.fuse_modules.fusion_in_one import \
    MaxFusion, AttFusion, V2VNetFusion, V2XViTFusion, When2commFusion, Where2commFusion, DiscoFusion, DAF
...
class BevEncodeSSFusion(nn.Module):
    ...
    def __init__(self, fusion_args):  # inC: 64  outC: not 1 for object detection
        ...
        elif fusion_args['core_method'] == "daf":
            self.fuse_module = DAF(256, vis_feats=0)
        else:
